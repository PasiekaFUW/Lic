...
histo11.GetXaxis().SetTitle("R Position [cm]")
histo11.GetYaxis().SetTitle("Z Position [cm]")
...
histo22.GetXaxis().SetTitle("Transverse Momentum Generated [GeV]")
histo22.GetYaxis().SetTitle("Transverse Momentum Simulated [Gev]")
fitFunc1=TF1("fitFunc1", "pol1", 0, 80)
...
histo23.GetXaxis().SetTitle("Transverse Momentum Generated [GeV]")
histo23.GetYaxis().SetTitle("Transverse Momentum Simulated [Gev]")
fitFunc1=TF1("fitFunc1", "pol1", 0, 80)
...
histo24.GetXaxis().SetTitle("Simulated and Generated Transverse Momentum Ratio [au]")
histo24.GetYaxis().SetTitle("Entries")
histo24.SetTitle("Ratio of Simulated to Generated Transverse Momentum (25–45 GeV Range) at Station 1 entry")
...
histo26.GetXaxis().SetTitle("Simulated and Generated Transverse Momentum Ratio [au]")
histo26.GetYaxis().SetTitle("Entries")
histo26.SetTitle("Ratio of Simulated to Generated Transverse Momentum (25–45 GeV Range) at Station 2 entry")
#c24.SetLeftMargin(0.15)  #Space for printing Y label
...
histo25.GetXaxis().SetTitle("Simulated and Generated Transverse Momentum Ratio [au]")
histo25.GetYaxis().SetTitle("Energy Loss [GeV]")
histo25.SetTitle("Difference in Muon Transverse Momentum Between Stations 1 and 2")
...
histo36.GetXaxis().SetTitle("Delta PhiB")
...
histo37.GetXaxis().SetTitle("Delta PhiB")
...
histo38.GetXaxis().SetTitle("Delta Phi")
...
histo39.GetXaxis().SetTitle("Delta Phi")
