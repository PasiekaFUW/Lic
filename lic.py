...
#process = cms.Process('OmtfTree') #GJ Comment
...
fileNames = cms.untracked.vstring(files), #GJ
...
process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(44000) ) #GJ

#
# import of standard configurationsI
#
process.load('Configuration.StandardSequences.Services_cff')
process.load('SimGeneral.HepPDTESSource.pythiapdt_cfi')
process.load('Configuration.EventContent.EventContent_cff') #GJ uncomment (UC)
...
process.load("Configuration.StandardSequences.Reconstruction_cff") #GJ added
...
process.MessageLogger.cerr.FwkReport.reportEvery = 4000 #GJ
